...
SRCS = main.asm util.asm math.asm approx.asm compatibility.asm activation.asm forward_prop.asm loss.asm derivatives.asm gradient_descent.asm neural_net.asm
